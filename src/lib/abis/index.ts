...
export const CARD_CATALOG_ABI = CardCatalogABI as any;
export const REWARDS_ABI = RewardsABI as any;
export const LEADERBOARD_ABI = LeaderboardABI as any;
export const AUCTION_ABI = AuctionABI as any;
